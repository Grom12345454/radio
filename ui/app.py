...
class RadioApp:
    ...
    def setup_styles(self):
        ...
        # ВАЖНО:
        # Здесь специально НЕТ Radio.TScale.
        #
        # Старый ttk.Scale со стилем Radio.TScale вызывал:
        #
        # Layout Horizontal.Radio.TScale not found
        #
        # Вместо него используется обычный tk.Scale.
    ...
    def setup_ui(self):
        ...
        # ========================================================
        # ИСПРАВЛЕННЫЙ VOLUME SLIDER
        #
        # Используем tk.Scale вместо ttk.Scale.
        #
    ...
    def setup_hotkeys(self):
        ...
        self.root.bind(
            "<Up>",
            lambda event: self.change_volume(5),
        )
    ...
    def on_search(self, event=None):
        ...
        self.filtered_stations = search_stations(
            query,
        )
    ...
    def get_selected_station(self):
        ...
        if index >= len(self.filtered_stations):
            return None

        return self.filtered_stations[index]
